...
\caption{Histogram and Gaussian mixture estimate of the distribution of 1143 median posterior Excitement Trend Indices from the NBA 2019--2020 season (left panel) and the median posterios ETIs as a function of calender time from October 22, 2019 to October 11, 2020 (right panel).}
\label{fig2}
\end{figure}
...
tab$group <- NA
knitr::kable(tab[,c("Team", "Average", "SD", "2.5%", "50%", "97.5%", "group")], 
						 row.names=FALSE, digits=2, booktabs = TRUE, format="latex", 
						 longtable=FALSE, linesep = c("", "", "", ""), 
						 align=c("l|", "r", "r", "r", "r", "r|", "r"),
						 caption="Team specific average posterior median Excitement Trend Indices calculated across all matches in the 2019--2020 NBA season along with standard deviations and 2.5\\% and 97.5\\% percentiles. The column denoted group shows the cluster to which each team was assigned by the .... algorithm.\\label{tab:teamsummary}")
```
