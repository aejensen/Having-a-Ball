...
Figure 5 shows the relationship between the seasonal standard deviation of the estimated ETI and the seasonal average estimated ETI. The teams follow a straight line through the origin fairly well, suggesting that the coefficient of variation is fairly constant across the teams. This also suggests that the teams with large seasonal average ETI are also more likely to be part of really spectacular games with high ETI.
...
```{r linplot2, echo=FALSE, message=FALSE, fig.cap="Ohoy"}
