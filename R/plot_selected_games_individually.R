...
load("../results/summary_selected_games.RData")
...
# Min plot
########################################
pdf("../figures/fig4_1.pdf", width = 8, height = 4)
par(mfrow=c(1,3), bty="n", mar = c(2.7, 2.7, 2.5, 0), mgp=c(1.5,0.4,0), 
...
lines(min_summary$t, min_summary$TDI_mean*100, lwd=2)
...
# Quant 25 plot
########################################
pdf("../figures/fig4_2.pdf", width = 8, height = 4)
par(mfrow=c(1,3), bty="n", mar = c(2.7, 2.7, 2.5, 0), mgp=c(1.5,0.4,0), 
    bty="n", cex.axis=1, cex.lab=1.3, cex.main=1.2)
...
lines(quant25_summary$t, quant25_summary$TDI_mean*100, lwd=2)
lines(c(0,48), c(50,50), lty = 2)
dev.off()
...
# Median plot
########################################
pdf("../figures/fig4_3.pdf", width = 8, height = 4)
par(mfrow=c(1,3), bty="n", mar = c(2.7, 2.7, 2.5, 0), mgp=c(1.5,0.4,0), 
    bty="n", cex.axis=1, cex.lab=1.3, cex.main=1.2)
...
lines(median_summary$t, median_summary$TDI_mean*100, lwd=2)
lines(c(0,48), c(50,50), lty = 2)
dev.off()
...
# Quanat 75 plot
########################################
pdf("../figures/fig4_4.pdf", width = 8, height = 4)
par(mfrow=c(1,3), bty="n", mar = c(2.7, 2.7, 2.5, 0), mgp=c(1.5,0.4,0), 
    bty="n", cex.axis=1, cex.lab=1.3, cex.main=1.2)
...
lines(quant75_summary$t, quant75_summary$TDI_mean*100, lwd=2)
lines(c(0,48), c(50,50), lty = 2)
dev.off()
...
# Max plot
########################################
pdf("../figures/fig4_5.pdf", width = 8, height = 4)
par(mfrow=c(1,3), bty="n", mar = c(2.7, 2.7, 2.5, 0), mgp=c(1.5,0.4,0), 
    bty="n", cex.axis=1, cex.lab=1.3, cex.main=1.2)
...
lines(max_summary$t, max_summary$TDI_mean*100, lwd=2)
lines(c(0,48), c(50,50), lty = 2)
dev.off()
